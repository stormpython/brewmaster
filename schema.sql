...
CREATE TABLE IF NOT EXISTS beer (
  ...
  original_gravity DECIMAL(1, 3) UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS styles (
  ...
  abv_min DECIMAL(2, 1) UNSIGNED NULL,
  abv_max DECIMAL(2, 1) UNSIGNED NULL,
  srm_min TINYINT UNSIGNED NULL,
  srm_max TINYINT UNSIGNED NULL,
  og_min DECIMAL(1, 3) UNSIGNED NULL,
  og_max DECIMAL(1, 3) UNSIGNED NULL,
  fg_min DECIMAL(1, 3) UNSIGNED NULL,
  fg_max DECIMAL(1, 3) UNSIGNED NULL,
  create_date DATETIME NULL,
